...
CacheAddressBlock::CacheAddressBlock(const machine::Cache *cache, unsigned width) {
    ...
    connect(cache, SIGNAL(cache_update(std::uint32_t,std::uint32_t,std::uint32_t,bool,bool,std::uint32_t,const std::uint32_t*,bool)),
            this, SLOT(cache_update(std::uint32_t,std::uint32_t,std::uint32_t,bool,bool,std::uint32_t,const std::uint32_t*,bool)));
}
